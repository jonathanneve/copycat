#
# Don't edit, this file is generated by FPCMake Version 2.0.0 [2015/02/14]
#
default: all
...
override TARGET_UNITS+=copycat.pas
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_OPTIONS+=-MObjFPC -Scghi -O1 -g -gl -l -vewnhibq
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_OPTIONS+=-MObjFPC -Scghi -O1 -g -gl -l -vewnhibq
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_UNITDIR+=. C:/lazarus/packager/units/$(CPU_TARGET)-$(OS_TARGET)
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_UNITDIR+=. C:/lazarus/packager/units/$(CPU_TARGET)-$(OS_TARGET)
endif
