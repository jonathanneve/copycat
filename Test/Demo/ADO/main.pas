...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
	...
	CcConf, CcConfStorage, CcReplicator, ExtCtrls, Buttons, DB, CcDB,
  CcConnADO;
...
type
  TMainForm = class(TForm)
    ...
    CcConnectionADO2: TCcConnectionADO;
...
//	RemoteConnection := YYY;
	...
	LocalConnection := CcConnectionADO1;
	RemoteConnection := CcConnectionADO2;
