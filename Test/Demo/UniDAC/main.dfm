object MainForm: TMainForm
  ...
  object FDConnection1: TFDConnection
    Params.Strings = (
      'Database=c:\projects-data\livemirror\master.fdb'
      'User_Name=sysdba'
      'Password=masterkey'
      'DriverID=fB')
  ...
  object FDConnection2: TFDConnection
    Params.Strings = (
      'Database=c:\projects-data\livemirror\mirror.fdb'
      'User_Name=sysdba'
      'Password=masterkey'
      'DriverID=fB')
    TxOptions.AutoStop = False
  ...
  object qTest: TCcQuery
    SelectStatement = True
    Connection = CcConnectionFireDAC1
    ParamCheck = True
    SQL.Strings = (
      
        'select * from RPL$TABLES_CONFIG where %upper_case(config_name) =' +
        ' %upper_case(:config_name)'
      'and table_name = '#39'HIS_PERSONS'#39)
    Left = 426
    Top = 305
  end
end
