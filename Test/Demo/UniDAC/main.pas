...
uses
  ...
  Vcl.DBGrids, FireDAC.Comp.DataSet, CcMemDS, CcDB;
...
procedure TMainForm.ReplicatorRowReplicated(Sender: TObject;
  TableName: string; Fields: TCcMemoryFields);
var
  i: Integer;
  primaryKeys: string;
begin
...
procedure TMainForm.ReplicatorReplicationError(Sender: TObject;
