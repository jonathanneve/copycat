...
uses
  ...
  CcMemDS, CcDB, nxllTransport,
  nxptBasePooledTransport, nxtwWinsockTransport, nxsdServerEngine,
  nxreRemoteServerEngine, nxdb, nxllComponent, CcProvNexusDB;
...
type
  TMainForm = class(TForm)
    ...
    Image10: TImage;
    Label27: TLabel;
    CcConnectionNexusDB1: TCcConnectionNexusDB;
    CcConnectionNexusDB2: TCcConnectionNexusDB;
...
//	RemoteConnection := YYY;
	...
	LocalConnection := CcConnectionNexusDB1;
	RemoteConnection := CcConnectionNexusDB2;
