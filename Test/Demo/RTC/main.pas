...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
	...
	CcConf, CcReplicator, ExtCtrls, Buttons, DB, CcDB,
 CcTransports, CcRTCTransport, FireDAC.Stan.Intf,
  FireDAC.Stan.Option, FireDAC.Stan.Error, FireDAC.UI.Intf, FireDAC.Phys.Intf,
  FireDAC.Stan.Def, FireDAC.Stan.Pool, FireDAC.Stan.Async, FireDAC.Phys,
  rtcDataCli, rtcCliModule, rtcConn, rtcHttpCli, rtcFunction, rtcDataSrv,
  rtcSrvModule, rtcInfo, rtcHttpSrv, FireDAC.Comp.Client, CcProvFireDAC,
...
type
  TMainForm = class(TForm)
    ...
    Image10: TImage;
    Label27: TLabel;
    CcRtcClientTransport1: TCcRtcClientTransport;
    CcConnectionFireDAC1: TCcConnectionFireDAC;
    CcRtcServerTransport1: TCcRtcServerTransport;
  ...
  private
    ...
    procedure SetRemoteConnectionParams;
  public
    { Public declarations }
  end;
...
uses FireDAC.VCLUI.ConnEdit, ShellAPI;
...
//	RemoteConnection := YYY;
	...
	RemoteConnection := CcRtcClientTransport1;
...
begin
//  CcRtcServerTransport1.StartServer;
...
procedure TMainForm.SetRemoteConnectionParams;
begin
  RtcHttpClient.ServerAddr := Trim(edHost.Text);
  RtcHttpClient.ServerPort := Trim(edPort.Text);
end;
...
begin
	RemoteConfig.ConnectAndRemoveConfig;
	RemoteConfig.Disconnect;
end;
...
begin
  TfrmFDGUIxFormsConnEdit.Execute(FDConnection1, '');
end;
