...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
	...
	CcConf, CcConfStorage, CcReplicator, ExtCtrls, Buttons, DB, CcProvIBDAC, CcDB;
...
type
  TMainForm = class(TForm)
    ...
    Image10: TImage;
    Label27: TLabel;
    CcConnectionIBDAC1: TCcConnectionIBDAC;
    CcConnectionIBDAC2: TCcConnectionIBDAC;
...
//	RemoteConnection := YYY;
	...
	LocalConnection := CcConnectionIBDAC1;
	RemoteConnection := CcConnectionIBDAC1;
