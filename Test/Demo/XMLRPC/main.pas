...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
	...
	CcConf, CcDb, CcReplicator, ExtCtrls, Buttons, DB,
  CcTransports, FireDAC.Stan.Intf,
  FireDAC.Stan.Option, FireDAC.Stan.Error, FireDAC.UI.Intf, FireDAC.Phys.Intf,
  FireDAC.Stan.Def, FireDAC.Stan.Pool, FireDAC.Stan.Async, FireDAC.Phys,
  FireDAC.Comp.Client, CcProvFireDAC,
  FireDAC.VCLUI.Wait, FireDAC.Phys.IBBase, FireDAC.Phys.FB, FireDAC.Comp.UI,
  CcXMLRPCTransport, CcXmlRpcServer;
...
//	RemoteConnection := YYY;
	...
	RemoteConnection := CcXmlRpcClientTransport1;
...
begin
  CcXmlRpcServerTransport1.StartServer;
...
begin
  CcXmlRpcServerTransport1.StopServer;
...
begin
  Replicator.BatchImport('HOTEL', sdRemoteToLocal, '0=0', '0=0', true);
end;
