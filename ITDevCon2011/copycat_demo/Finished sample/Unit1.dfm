object Form1: TForm1
  ...
  object CcReplicatorA: TCcReplicator
    ...
    Nodes.LocalNode.Connection = HeadDB
    Nodes.LocalNode.Name = 'HEAD'
    Nodes.RemoteNode.Connection = BranchADB
    Nodes.RemoteNode.Name = 'BRANCH A'
  ...
  object CcReplicatorB: TCcReplicator
    ...
    Nodes.LocalNode.Connection = HeadDB
    Nodes.LocalNode.Name = 'HEAD'
    Nodes.RemoteNode.Connection = BranchBDB
    Nodes.RemoteNode.Name = 'BRANCH B'
    AutoReplicate.Frequency = 30
    AutoReplicate.Enabled = False
    AutoCommit.Frequency = 30
    AutoCommit.CommitType = ctNone
  ...
  object HeadDB: TCcConnectionUIB
    ...
    DBType = 'Interbase'
    DBVersion = 'FB2.5'
    DBName = 'c:\copycat_demo\Finished sample\head_office.fdb'
    TRParams.Strings = (
      'write'
      'nowait'
      'concurrency')
  ...
  object BranchADB: TCcConnectionUIB
    ...
    DBType = 'Interbase'
    DBVersion = 'FB2.5'
    DBName = 'c:\copycat_demo\Finished sample\branch a.fdb'
    TRParams.Strings = (
      'write'
      'nowait'
      'concurrency')
  ...
  object BranchBDB: TCcConnectionUIB
    ...
    DBType = 'Interbase'
    DBVersion = 'FB2.5'
    DBName = 'c:\copycat_demo\Finished sample\branch b.fdb'
    TRParams.Strings = (
      'write'
      'nowait'
      'concurrency')
